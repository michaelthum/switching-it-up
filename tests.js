...
describe('Scoring', () => {
  it('returns the score for a quarterback', () => {
    ...
    expect(calculateScore(player)).to.equal(40.72)
  })
  ...
  it('returns the score for a running back', () => {
    ...
    expect(calculateScore(player)).to.equal(32)
  })
  ...
  it('returns the score for a receiver', () => {
    ...
    expect(calculateScore(player)).to.equal(32.3)
  })
  ...
  it('returns the score for a tightend', () => {
    ...
    expect(calculateScore(player)).to.equal(33.7)
  })
